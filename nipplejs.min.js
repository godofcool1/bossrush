! function(t, i) {
  ...
  return e = [function(t, i, e) {
    ...
    function n(t) {
      f.has(t) && clearTimeout(f.get(t)), f.set(t, setTimeout(t, 100))
    }
    ...
    y ? u = {
    ...
    }, x = g) : u = g, O.prototype.on = function(t, i) {
      var e, o = t.split(/[ ,]+/g);
      ...
      }, s(t, u[i], e._domHandlers_[i]), x[i] && s(t, x[i], e._domHandlers_[i]), e
    }, O.prototype.unbindEvt = function(t, i) {
      return this._domHandlers_ = this._domHandlers_ || {}, o(t, u[i], this._domHandlers_[i]), x[i] && o(t, x[i], this._domHandlers_[i]), delete this._domHandlers_[i], this
    };
    y = O;
    ...
    w.prototype = new y, (w.constructor = w).id = 0, w.prototype.buildEl = function(t) {
      ...
      var t = this.options.fadeTime + "ms",
        i = function() {
          var t, i = c("borderRadius");
          for (t in i) i.hasOwnProperty(t) && (i[t] = "50%");
          return i
        }(),
        t = a("transition", "opacity", t),
        e = {};
      return e.el = {
        position: "absolute",
      ...
      }, l(e.el, t), "circle" === this.options.shape && l(e.back, i), l(e.front, i), this.applyStyles(e), this
      ...
      var t, e, o = this;
      return o.options.dataOnly || (o.ui.el.style.opacity = o.options.restOpacity, clearTimeout(o.removeTimeout), clearTimeout(o.showTimeout), clearTimeout(o.restTimeout), o.removeTimeout = setTimeout(function() {
        var t = "dynamic" === o.options.mode ? "none" : "block";
        o.ui.el.style.display = t, "function" == typeof i && i.call(o), o.trigger("hidden", o.instance)
      }, o.options.fadeTime), o.options.restJoystick && (t = o.options.restJoystick, (e = {}).x = !0 === t || !1 !== t.x ? 0 : o.instance.frontPosition.x, e.y = !0 === t || !1 !== t.y ? 0 : o.instance.frontPosition.y, o.setPosition(i, e))), o
    }, w.prototype.setPosition = function(t, i) {
      var e = this,
        i = (e.frontPosition = {
          x: i.x,
          y: i.y
        }, e.options.fadeTime + "ms"),
        o = {},
        i = (o.front = a("transition", ["transform"], i), {
          front: {}
        });
      i.front = {
        transform: "translate(" + e.frontPosition.x + "px," + e.frontPosition.y + "px)"
      }, e.applyStyles(o), e.applyStyles(i), e.restTimeout = setTimeout(function() {
        "function" == typeof t && t.call(e), e.restCallback()
      }, e.options.fadeTime)
    }, w.prototype.restCallback = function() {
      var t = {};
      t.front = a("transition", "none", ""), this.applyStyles(t), this.trigger("rested", this.instance)
    ...
    function T(t, i) {
      this.nipples = [], this.idles = [], this.actives = [], this.ids = [], this.pressureIntervals = {}, this.manager = t, this.id = T.id, T.id += 1, this.defaults = {
        zone: document.body,
        multitouch: !1,
      ...
      t = getComputedStyle(this.options.zone.parentElement);
      return t && "flex" === t.display && (this.parentIsFlex = !0), this.updateBox(), this.prepareNipples(), this.bindings(), this.begin(), this.nipples
    }
    T.prototype = new y, (T.constructor = T).id = 0, T.prototype.prepareNipples = function() {
      var o = this.nipples;
      ...
      var e = this.manager.scroll,
        ...
        s = (t.x && t.y ? o = {
          x: t.x - s,
          y: t.y - r
        } : (t.top || t.right || t.bottom || t.left) && ((s = document.createElement("DIV")).style.display = "hidden", s.style.top = t.top, s.style.right = t.right, s.style.bottom = t.bottom, s.style.left = t.left, s.style.position = "absolute", n.zone.appendChild(s), r = s.getBoundingClientRect(), n.zone.removeChild(s), o = t, t = {
          x: r.left + e.x,
          y: r.top + e.y
        }), new _(this, {
          color: n.color,
      ...
      return n.dataOnly || (p(s.ui.el, o), p(s.ui.front, s.frontPosition)), this.nipples.push(s), this.trigger("added " + s.identifier + ":added", s), this.manager.trigger("added " + s.identifier + ":added", s), this.bindNipple(s), s
      ...
      var o = this,
        i = o.options,
        n = e;
      return e = r(e), o.updateBox(), h(e, function(t) {
      ...
      function t(t) {
        t.trigger("start", t), e.trigger("start " + t.id + ":start", t), t.show(), 0 < s && e.pressureFn(i, t, t.identifier), e.processOnMove(i)
      }
      var e = this,
        o = e.options,
        n = e.manager.getIdentifier(i),
        s = i.force || i.pressure || i.webkitForce || 0,
        r = {
          x: i.pageX,
          y: i.pageY
        },
        d = e.getOrCreate(n, r);
      d.identifier !== n && e.manager.removeIdentifier(d.identifier), d.identifier = n;
      if (0 <= (n = e.idles.indexOf(d)) && e.idles.splice(n, 1), e.actives.push(d), e.ids.push(d.identifier), "semi" !== o.mode) t(d);
      else {
        if (!(v(r, d.position) <= o.catchDistance)) return d.destroy(), void e.processOnStart(i);
        t(d)
      }
      return d
    }, T.prototype.getOrCreate = function(t, i) {
      var e, o = this.options;
      return /(semi|static)/.test(o.mode) ? (e = this.idles[0]) ? (this.idles.splice(0, 1), e) : "semi" === o.mode ? this.createNipple(i, t) : (console.warn("Coudln't find the needed nipple."), !1) : this.createNipple(i, t)
    }, T.prototype.processOnMove = function(t) {
      var i = this.options,
        e = this.manager.getIdentifier(t),
        o = this.nipples.get(e),
        n = this.manager.scroll;
      if (s = t, isNaN(s.buttons) ? 0 !== s.pressure : 0 !== s.buttons) {
        if (!o) return console.error("Found zombie joystick with ID " + e), void this.manager.removeIdentifier(e);
        i.dynamicPage && (s = o.el.getBoundingClientRect(), o.position = {
          x: n.x + s.left,
          y: n.y + s.top
        }), o.identifier = e;
        ...
        i.lockX && (e.y = o.position.y), i.lockY && (e.x = o.position.x);
        var r, d, p, a, c, l = v(e, o.position),
          h = (h = e, u = o.position, f = u.x - h.x, u = u.y - h.y, Math.atan2(u, f) * (180 / Math.PI)),
          u = b(h),
          f = l / s,
          y = {
            distance: l,
          ...
          m = ("circle" === o.options.shape ? (r = Math.min(l, s), d = o.position, p = r, c = {
            x: 0,
            y: 0
          }, a = b(h), c.x = d.x - p * Math.cos(a), c.y = d.y - p * Math.sin(a), d = c) : (p = e, a = o.position, c = s, d = {
            x: Math.min(Math.max(p.x, a.x - c), a.x + c),
            y: Math.min(Math.max(p.y, a.y - c), a.y + c)
          }, r = v(d, o.position)), i.follow ? s < l && (m = e.x - d.x, g = e.y - d.y, o.position.x += m, o.position.y += g, o.el.style.top = o.position.y - (this.box.top + n.y) + "px", o.el.style.left = o.position.x - (this.box.left + n.x) + "px", l = v(e, o.position)) : (e = d, l = r), e.x - o.position.x),
          g = e.y - o.position.y,
          n = (o.frontPosition = {
            x: m,
            y: g
          }, i.dataOnly || (o.ui.front.style.transform = "translate(" + m + "px," + g + "px)"), {
        ...
        (n = o.computeDirection(n)).angle = {
          radian: b(180 - h),
          degree: 180 - h
        }, o.trigger("move", n), this.trigger("move " + o.id + ":move", n)
    ...
    function P(t) {
      ...
      var o = this;
      o.ids = {}, o.index = 0, o.collections = [], o.scroll = d(), o.config(t), o.prepareCollections(), s(window, "resize", function() {
        n(i)
      });
    ...
    P.prototype = new y, (P.constructor = P).prototype.prepareCollections = function() {
      var t = this;
      ...
      return h(i, function(t) {
        e = o.getIdentifier(t), h(o.collections, function(t, i, e) {
  ...
  }], o = {}, n.m = e, n.c = o, n.d = function(t, i, e) {
